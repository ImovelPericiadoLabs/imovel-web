  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2">
        <TextTitle>Conta Selecionada</TextTitle>
        ...
        <div className="p-4 bg-white border border-box rounded-sm">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-xs font-normal leading-[150%]">
              Verifique se o imóvel é seguro para comprar. Detecte ônus, ações e pendências ocultas
              e receba um relatório claro com o status legal completo. Não compre sem consultar.
            </p>
          </div>
        </div>
      </div>

      <div className="absolute bottom-0 left-0 right-0 px-4 pt-5 pb-7 bg-white mt-auto border-t border-box">
