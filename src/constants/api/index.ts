...
export const endpoint = {
  ...
  staff: {
    ...
    /** Vouchers de evento presencial (spec 07 do backend). */
    voucherBatches: '/admin/staff/voucher-batches/',
    voucherBatch: (id: string) => `/admin/staff/voucher-batches/${id}/`,
    voucherBatchExpire: (id: string) => `/admin/staff/voucher-batches/${id}/expire/`,
    voucherBatchGenerate: (id: string) => `/admin/staff/voucher-batches/${id}/generate/`,
    voucherBatchVouchers: (id: string) => `/admin/staff/voucher-batches/${id}/vouchers/`,
    voucherBatchReport: (id: string) => `/admin/staff/voucher-batches/${id}/report/`,
    voucherBatchPdf: (id: string) => `/admin/staff/voucher-batches/${id}/pdf/`,
    voucherCancel: (id: string) => `/admin/staff/vouchers/${id}/cancel/`,
    voucherReissue: (id: string) => `/admin/staff/vouchers/${id}/reissue/`,
    voucherEvents: (id: string) => `/admin/staff/vouchers/${id}/events/`,
  ...
  messaging: {
    ...
    conversationHandoff: (id: string) => `/staff/inbox/conversations/${id}/handoff/`,
    conversationToggleAi: (id: string) => `/staff/inbox/conversations/${id}/toggle-ai/`,
